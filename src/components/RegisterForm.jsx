...
const RegisterForm = ({ onClose }) => {
  ...
  const { login } = useAuth(); // Функція для збереження користувача в контексті
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      // Зберігаємо дані в AuthContext і localStorage
      login(newUser);

      if (onClose) onClose(); // Закриваємо модальне вікно
    }
  };
